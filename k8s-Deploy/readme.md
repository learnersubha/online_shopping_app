...
Move-Item .\kind-windows-amd64.exe c:\some-dir-in-your-PATH\kind.exe
 ...
 namespace.yaml:-> https://github.com/learnersubha/online_shopping_app/blob/master/k8s-Deploy/Namespacefile
...
Now create a service to connect with the outer world. Kubernetes Services are API objects that enable network exposure for one or more cluster Pods. 
 service.yaml:-> https://github.com/learnersubha/online_shopping_app/blob/master/k8s-Deploy/Servicefile
